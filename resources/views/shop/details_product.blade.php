                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="{{ asset('storage/' . $product->image) }}" width="674"
                                     height="674" alt="" />
        ...
        <div class="col-lg-5">
            ...
            <div class="product-single__short-desc">
                ...
                @if($product->quantity <= 0)
                    <!-- Jeśli produkt jest niedostępny (ilość <= 0), pokaż link do sklepu -->
                    <a class="btn btn-danger mb-2" href="{{ route('shop.index') }}">Produkt niedostępny <i class="fa-solid fa-shop-slash"></i></a>
                @elseif(Cart::instance('cart')->content()->where('id', $product->id)->count() > 0)
                    <!-- Jeśli produkt jest już w koszyku, pokaż komunikat -->
                    <a  class="btn btn-info mb-2" href="{{route('cart.index')}}">Produkt jest w koszyku  <i class="fa-solid fa-cart-shopping"></i></a>
                @else
                    <!-- Jeśli produkt jest dostępny i nie ma go w koszyku, wyświetl formularz dodawania do koszyka -->
